...
//              + '\n[<:Twitch:364781668222894080>/asathrorr__eriadan](https://www.twitch.tv/asathrorr__eriadan)'
          ...
          default : msgEmbed
            ...
            .addField( 'Sirannon (#' + ( srtdServers.indexOf( lstServers[ intSira ] ) + 1 ) + ': ' + onServer[ intSira ] + '/' + fromServer[ intSira ] + ' = ' + Math.floor( ( onServer[ intSira ] / fromServer[ intSira ] ) * 100 ) + '%)', '<@&203267093372731392> is a primarily <@&226397066887168000> speaking server.  For more details, please ' + ( message.channel.id === '637272044056084480' ? '' : 'visit <#201689631861899264> and ' ) + 'type `!noserver Sirannon`' )// Sirannon
